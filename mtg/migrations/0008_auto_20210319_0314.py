...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='card',
            name='color_identity',
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('W', 'White'), ('U', 'Blue'), ('B', 'Black'), ('R', 'Red'), ('G', 'Green'), ('C', 'Colorless')], max_length=6), default=list, size=None),
        ),
        migrations.AlterField(
            model_name='card',
            name='colors',
